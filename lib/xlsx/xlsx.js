...
const CellStyleXform = require('./xform/style/cell-style-xform');
...
class XLSX {
  ...
  reconcile(model, options) {
    ...
    const cellStyleXform = new CellStyleXform();
    ...
    // reconcile cell styles
    const cellStylesOptions = {
      styles: model.styles,
    };
    model.cellStyles.forEach(cellStyle => {
      cellStyleXform.reconcile(cellStyle, cellStylesOptions);
    });
      ...
      if (!entry.dir) {
        ...
        switch (entryName) {
          ...
          case 'xl/styles.xml':
            ...
            model.cellStyles = model.styles.model.cellStyles;
            break;
  ...
  prepareModel(model, options) {
    ...
    model.cellStyles.forEach(cellStyle => {
      cellStyleXform.prepare(cellStyle, cellStylesOptions);
    });
